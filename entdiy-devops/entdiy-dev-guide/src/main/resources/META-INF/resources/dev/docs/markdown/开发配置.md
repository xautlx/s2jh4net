...
### Java IDE： IDEA/Eclipse/Spring Tool Suite

项目采用标准的Maven结构，按照各IDE的project open或import功能，正常情况是能直接导入到IDE的工作空间并自动构建编译。
...
* 修改application.properties或jdbc.properties文件中的jdbc.url参数值为mysql格式，例如：jdbc:mysql://127.0.0.1:3306/s2jh4net?characterEncoding=utf8