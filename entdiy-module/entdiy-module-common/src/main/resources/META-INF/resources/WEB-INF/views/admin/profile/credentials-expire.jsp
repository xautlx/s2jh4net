...
<div class="row">
    <div class="col-md-12">
        <form class="form form-horizontal form-bordered form-label-stripped" method="post"
            ...
            <div class="form-body">
                <input type="hidden" name="redirectURI" value="/admin">
                <div class="form-group">
                    <label class="control-label">输入当前密码</label>
                    <div class="controls">
            ...
            <div class="form-actions right">
                <a class="btn default" href="/admin">本次跳过</a>
