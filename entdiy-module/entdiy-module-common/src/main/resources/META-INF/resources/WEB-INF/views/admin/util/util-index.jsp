        ...
        <div class="portlet">
            ...
            <div class="portlet-body">
                <form class="form-horizontal form-bordered form-label-stripped"
                      method="post"
                      data-validation='true'
                      action="admin/util/logger-update">
                    <div class="form-body">
                        <div class="note note-info">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="loggerName" class="form-control"
                                       placeholder="root，特定logger名称等">
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div class="col-md-6">
        <div class="portlet">
            ...
            <div class="portlet-body">
                <div class="note note-info">
                    <p>提供基本的HTTP
                        Request和Session信息显示页面，用于在集群环境Failover切换不同主机检查确认服务是否正常，检查Session复制配置是否有效的实现了Session属性数据的无缝复制切换。
                    </p>
                </div>
                <a class="btn blue" href="admin/util/load-balance-test" target="_blank">点击显示负载均衡信息页面</a>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="portlet">
            ...
            <div class="portlet-body">
                ...
                <a class="btn blue" href="druid/" target="_blank">点击访问Druid数据源监控页面</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="portlet">
            ...
            <div class="portlet-body">
                <form class="form-horizontal form-bordered form-label-stripped"
                      method="post"
                      data-validation='true'
                      action="admin/util/systime/setup">
                    <div class="form-body">
                        <div class="note note-info">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="time" class="form-control" data-picker="date-time"
                                       required="true">
                            </div>
                        </div>
                    </div>
                    <div class="form-actions right">
                        ...
                        <button class="btn blue btn-post-url" type="button" data-url="admin/util/systime/reset"
                                data-confirm="false">恢复系统时间
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div class="portlet">
            ...
            <div class="portlet-body">
                <form class="form-horizontal form-bordered form-label-stripped"
                    ...
                    <div class="form-body">
                        <div class="note note-info">
                            <p>在开发dev.mode=true运行模式下，为了避免相互争夺接收消息，默认关闭消息监听服务。</p>
                            <p>在开发和测试过程中，根据需要人工控制开启或关闭监听服务。</p>
                        </div>
                    </div>
                    <div class="form-actions right">
                        <button class="btn blue btn-post-url" type="button"
                                data-url="admin/util/brokered-message/listener-state?state=startup"
                                data-confirm="false">启动监听服务
                        </button>
                        <button class="btn blue btn-post-url" type="button"
                                data-url="admin/util/brokered-message/listener-state?state=shutdown"
                                data-confirm="false">关闭监听服务
                        </button>
                    </div>
                </form>
            </div>
