...
public class ExtLoggingJobHistoryPlugin extends LoggingJobHistoryPlugin {
    ...
    public void jobWasExecuted(JobExecutionContext context, JobExecutionException jobException) {
        ...
        jobRunHist.setFireTime(DateUtils.currentDateTime());
        jobRunHist.setPreviousFireTime(DateUtils.convertDateToLocalDateTime(trigger.getPreviousFireTime()));
        jobRunHist.setNextFireTime(DateUtils.convertDateToLocalDateTime(trigger.getNextFireTime()));
