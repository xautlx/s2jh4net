...
<head>
    ...
    <link href="assets/pages/site/css/slider.css" rel="stylesheet" type="text/css"/>
    <link href="assets/pages/site/css/style-shop.css" rel="stylesheet" type="text/css"/>
    <link href="assets/pages/site/css/style.css" rel="stylesheet" type="text/css"/>
    <link href="assets/pages/site/css/style-responsive.css" rel="stylesheet" type="text/css"/>
</head>
<!-- Head END -->
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 additional-shop-info">
                <ul class="list-unstyled list-inline">
                    <li><i class="fa fa-envelope-o"></i><span><a href="mailto:xautlx@hotmail.com">xautlx@hotmail.com</a></span></li>
                    <li><i class="fa fa-qq"></i><span>QQ: 2414521719</span></li>
                </ul>
            </div>
...
<script src="assets/pages/site/scripts/layout.js" type="text/javascript"></script>
<script src="assets/pages/site/scripts/bs-carousel.js" type="text/javascript"></script>
