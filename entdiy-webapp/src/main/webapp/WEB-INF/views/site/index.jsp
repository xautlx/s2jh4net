...
<head>
    ...
    <link href="${ctx}/assets/global/plugins/owl-carousel/owl.carousel.css" rel="stylesheet">

    <link href="${ctx}/assets/pages/site/css/slider.css" rel="stylesheet" type="text/css"/>
    <link href="${ctx}/assets/pages/site/css/style-shop.css" rel="stylesheet" type="text/css"/>
    <link href="${ctx}/assets/pages/site/css/style.css" rel="stylesheet" type="text/css"/>
    <link href="${ctx}/assets/pages/site/css/style-responsive.css" rel="stylesheet" type="text/css"/>
</head>
<!-- Head END -->
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4">
                <ul class="list-unstyled list-inline pull-right">
                    ...
                    <li><img src="assets/corporate/img/payments/visa.jpg" alt="We accept Visa" title="We accept Visa">
                    </li>
                </ul>
            </div>
            <!-- END PAYMENTS -->
            ...
            <div class="col-md-6 col-sm-6 col-xs-9">
                ...
                <div class="description">
                    <p>Lorem ipsum dolor ut sit ame dolore adipiscing elit, sed nonumy nibh sed euismod laoreet dolore
                        magna aliquarm erat volutpat Nostrud duis molestie at dolore.</p>
                </div>
...
<script src="${ctx}/assets/global/plugins/owl-carousel/owl.carousel.min.js" type="text/javascript"></script>

<script src="${ctx}/assets/pages/site/scripts/layout.js" type="text/javascript"></script>
<script src="${ctx}/assets/pages/site/scripts/bs-carousel.js" type="text/javascript"></script>
