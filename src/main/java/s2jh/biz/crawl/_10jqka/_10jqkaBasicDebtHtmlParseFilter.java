...
public class _10jqkaBasicDebtHtmlParseFilter extends AbstractHtmlParseFilter {
    ...
    private final static Set<String> whiteList = Sets.newHashSet(new String[] { "股东权益合计" });

    @Override
    public String getUrlFilterRegex() {
        return "^http://stockpage.10jqka.com.cn/basic/[0-9]+/debt.txt$";
    }
    ...
    protected String getPrimaryKey(String url) {
        return StringUtils.substringBetween(url, "http://stockpage.10jqka.com.cn/basic/", "/debt.txt");
    }
