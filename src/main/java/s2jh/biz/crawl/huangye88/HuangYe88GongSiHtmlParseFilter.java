...
public class HuangYe88GongSiHtmlParseFilter extends HuangYe88BaseHtmlParseFilter {
    ...
    public String getUrlFilterRegex() {
        return "^http://b2b.huangye88.com/gongsi/[^/]*/?";
    }

    @Override
    protected String getPrimaryKey(String url) {
        return StringUtils.substringBefore(StringUtils.substringAfter(url, "http://b2b.huangye88.com/gongsi/"), "/");
    }
}
