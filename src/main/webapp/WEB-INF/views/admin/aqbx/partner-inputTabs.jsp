...
<body>
	<div class="tabbable tabbable-custom tabbable-secondary">
		<ul class="nav nav-tabs" data-active="${param._tab_active}">
			...
			<li><a data-toggle="tab" href="${ctx}/admin/aqbx/partner/edit?id=${param.id}&clone=${param.clone}">基本信息</a></li>
			<li><a data-toggle="tab" href="${ctx}/admin/aqbx/partner/partnerNote-list?id=${param.id}">商谈纪要</a></li>
		</ul>
	</div>
</body>
</html>