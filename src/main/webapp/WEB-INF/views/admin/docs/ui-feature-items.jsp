...
<div id="docs-demo-list">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                <label class="control-label" data-tooltips="[输入提示说明内容]"
                                       data-tooltipster-position="bottom">普通文本输入元素/输入提示</label>
                                <div class="controls">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <form:input path="textContent" class="form-control"
                                                data-profile-param="just-mock-test"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
    ...
    <div class="portlet gren">
        ...
        <div class="portlet-body">
            <form:form class="form-horizontal form-bordered form-label-stripped form-validation"
                       action="${ctx}/docs/mock/validation-confirm" method="post" data-editrulesurl="false"
            ...
            <form:form class="form-horizontal form-bordered form-label-stripped form-validation" action="${ctx}/todo"
                ...
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
							<span class="help-block">
								<a href="${ctx}/docs/jsdoc/global.html#bindCaptchaCode"
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <p class="form-control-static">
                                        <a title="修改密码" data-modal-size="600px" data-toggle="modal-ajaxify"
                                           href="${ctx}/admin/profile/password">修改密码</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
							<span class="help-block">
								<a href="${ctx}/docs/jsdoc/global.html#bindModalAjaxify"
                                   target="_blank">Javascript用法文档</a>
							</span>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <button class="btn blue btn-post-url" type="button"
                                            data-url="${ctx}/docs/mock/btn-post" data-confirm="确认提交请求？">模拟按钮POST请求
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
							<span class="help-block">
								<a href="${ctx}/docs/jsdoc/global.html#bindBtnPostUrl"
                                   target="_blank">Javascript用法文档</a>
							</span>
                        </div>
                    </div>
    ...
    <div class="portlet gren">
        ...
        <div class="portlet-body">
            <form:form class="form-horizontal form-bordered form-label-stripped form-validation control-label-xl"
                       action="${ctx}/todo" method="post" modelAttribute="entity">
                <form:hidden path="id"/>
                <form:hidden path="version"/>
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
							<span class="help-block">
								<a href="${ctx}/docs/jsdoc/global.html#initTreeSelect"
                                   target="_blank">Javascript用法文档</a>
							</span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <form:select path="selectedId" items="${multiSelectOptions}" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <form:select path="textContent" items="${multiSelectTags}"
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <form:select path="selectedIds" items="${multiSelectOptions}" multiple="multiple"
                                                 class="form-control"/>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <form:select path="splitTexts" items="${multiSelectTags}"
                                                 multiple="multiple" data-tags="true" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
						<span class="help-block">
							<a href="${ctx}/docs/jsdoc/global.html#initMultiSelectDouble"
                               target="_blank">Javascript用法文档</a>
						</span>
                    </div>
                </div>
            ...
            <form:form class="form-horizontal form-bordered form-label-stripped form-validation control-label-lg"
                ...
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
							<span class="help-block">
								<a href="${ctx}/docs/jsdoc/global.html#initDatePicker"
                                   target="_blank">Javascript用法文档</a>
							</span>
                        </div>
                    </div>
    ...
    <div class="portlet gren">
        ...
        <div class="portlet-body">
            <form:form class="form-horizontal form-bordered form-label-stripped form-validation"
                       action="${ctx}/docs/mock/dynamic-table" method="post" data-editrulesurl="false"
                       modelAttribute="entity">
                <form:hidden path="id"/>
                <form:hidden path="version"/>
                <div class="form-actions">
                ...
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
							<span class="help-block">
								<a href="${ctx}/docs/jsdoc/global.html#initDynamicTable"
                                   target="_blank">Javascript用法文档</a>
							</span>
                        </div>
                    </div>
            ...
            <form:form class="form-horizontal form-bordered form-label-stripped form-validation control-label-xl"
                ...
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
							<span class="help-block">
								<a href="${ctx}/docs/jsdoc/global.html#initGmapsBaidu"
                                   target="_blank">Javascript用法文档</a>
							</span>
                        </div>
                    </div>
    ...
    <div class="portlet gren">
        ...
        <div class="portlet-body">
            <div class="row">
                    ...
                    <div class="row search-form-default">
                        <div class="col-md-12">
                            <form method="get" class="form-inline form-validation form-search-init"
                                  ...
                                  action="${ctx}/docs/mock/infinite-scroll?rows=3">
                                <div class="form-group">
                                    <div class="controls controls-clearfix">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-infinite-scroll" id="table-infinite-scroll-doc-demo">
                                ...
                                <tbody data-url="${ctx}/docs/mock/infinite-scroll?rows=3">
                                </tbody>
                            </table>
                        </div>
                    </div>
                ...
                <div class="col-md-2">
					<span class="help-block">
						<a href="${ctx}/docs/jsdoc/global.html#bindTableInfiniteScroll"
                           target="_blank">Javascript用法文档</a>
					</span>
                </div>
            </div>
