                                ...
                                <div class="controls">
                                    <div class="input-group">
                                        <div class="input-icon">
                                            <i class="fa fa-qrcode"></i> <input class="form-control captcha-text"
                                                                                type="text" autocomplete="off"
                                                                                placeholder="验证码...看不清可点击图片可刷新"
                                                                                name="captcha" required="true"/>
                                        </div>
                                        <span class="input-group-btn" style="cursor: pointer;">
											<img alt="验证码" class="captcha-img"
            ...
            <form:form class="form-horizontal form-bordered form-label-stripped form-validation control-label-xl"
                ...
                <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <form:select path="textContent" items="${multiSelectTags}"
                                                 data-select2-type="combobox" class="form-control"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
							<span class="help-block">
								<a href="${ctx}/docs/jsdoc/global.html#initSelect2Remote"
                                   target="_blank">Javascript用法文档</a>
							</span>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <form:select path="splitTexts" items="${multiSelectTags}" class="form-control"
                                             data-select2-type="tags" multiple="multiple"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <form:hidden path="filePath" class="form-control" data-upload="single-image"
