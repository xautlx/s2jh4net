...
<script src="${ctx}/assets/apps/scripts/component/dynamic-table.js?_=${build_version}"></script>
<script src="${ctx}/assets/apps/scripts/component/multi-select-double.js?_=${build_version}"></script>

<script src="${ctx}/assets/apps/scripts/component/image-uploader.js?_=${build_version}"></script>
<script src="${ctx}/assets/apps/scripts/component/file-uploader.js?_=${build_version}"></script>


<script src="${ctx}/assets/apps/scripts/component/grid.js" ?_=${build_version}></script>

<script src="${ctx}/assets/apps/scripts/function/data-profile-param.js?_=${build_version}"></script>
