...
<head>
    ...
    <link href="${ctx}/assets/apps/css/admin.css?_=${build_version}" rel="stylesheet" type="text/css"/>
        ...
        <div class="page-header-inner ">
            ...
            <div class="page-logo">
                <a class="navbar-brand" href="${ctx}/admin"
                   style=" padding-top: 12px; padding-left: 10px"><font
                ...
                <ul class="nav navbar-nav pull-right" style="margin-right: 0px">
                    ...
                    <li class="dropdown dropdown-extended" id="header_notification_bar">
                        <a href="javascript:;" class="dropdown-toggle"
                           ...
                           data-path="公告信息列表"
                           rel="address:/admin/profile/notify-message">
                    ...
                    <li class="dropdown dropdown-extended" id="header_inbox_bar">
                        <a href="javascript:;" class="dropdown-toggle"
                           ...
                           data-close-others="true"
                           data-path="个人消息列表"
                           data-hash="/admin/profile/user-message">
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            <li><a href="javascript:;" data-hash="/admin/profile/edit" data-path="个人配置"><i class="fa fa-user"></i> 个人配置</a></li>
                            <li><a href="${ctx}/admin/profile/password" data-toggle="modal-ajaxify"
                    ...
                    <li class="dropdown dropdown-extended" id="theme-toggler" style="padding-left: 0px">
                ...
                <div class="page-bar" id="layout-nav">
                    ...
                    <div class="page-toolbar">
                        <div class="btn-group pull-right">
                            ...
                            <button class="btn default" type="button" onclick="$(this).prev('ul.dropdown-menu').find('li.active span.badge').click()">
...
<script src="${ctx}/assets/apps/plugins/jquery-tmpl/jquery.tmpl.min.js"></script>
...
<script src="${ctx}/assets/apps/plugins/kindeditor/kindeditor-ext.js"></script>
...
<script src="${ctx}/assets/apps/scripts/admin-theme.js?_=${build_version}"></script>
<script src="${ctx}/assets/apps/scripts/grid.js"?_=${build_version}></script>
<script src="${ctx}/assets/apps/scripts/dynamic-table.js?_=${build_version}"></script>
...
<script src="${ctx}/assets/apps/scripts/biz.js?_=${build_version}"></script>
