...
<script src="${ctx}/assets/apps/scripts/function/misc.js?_=${build_version}"></script>

<script src="${ctx}/assets/apps/scripts/component/select.js?_=${build_version}"></script>
<script src="${ctx}/assets/apps/scripts/component/date-picker.js?_=${build_version}"></script>
<script src="${ctx}/assets/apps/scripts/component/date-time-picker.js?_=${build_version}"></script>
<script src="${ctx}/assets/apps/scripts/component/date-range-picker.js?_=${build_version}"></script>
<script src="${ctx}/assets/apps/scripts/component/slimscroll-panel.js?_=${build_version}"></script>
<script src="${ctx}/assets/apps/scripts/component/qrcode.js?_=${build_version}"></script>
<script src="${ctx}/assets/apps/scripts/component/table-ajax-sorting.js?_=${build_version}"></script>




<script src="${ctx}/assets/apps/scripts/form/validator-additional-method.js?_=${build_version}"></script>
<script src="${ctx}/assets/apps/scripts/form/form-validation.js?_=${build_version}"></script>

<script src="${ctx}/assets/apps/scripts/component/table-infinite-scroll.js?_=${build_version}"></script>
<script src="${ctx}/assets/apps/scripts/component/ajax-bootstrap-tabs.js?_=${build_version}"></script>

<script src="${ctx}/assets/apps/scripts/function/image-captcha-code.js?_=${build_version}"></script>
<script src="${ctx}/assets/apps/scripts/function/popup-captcha-code.js?_=${build_version}"></script>
<script src="${ctx}/assets/apps/scripts/function/mobile-sms-code.js?_=${build_version}"></script>
