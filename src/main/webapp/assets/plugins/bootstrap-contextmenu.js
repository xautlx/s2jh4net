...
!(function($) {
    ...
    ContextMenu.prototype = {
        ...
        show : function(e) {
            ...
            var $this = $(this), $menu, $contextmenu, evt;
            ...
            $menu.attr('style', '').css(tp).data('_context_this_ref', this).addClass('open');
        ...
        getPosition : function(e, $menu) {
            var mouseX = e.clientX, mouseY = e.clientY, boundsX = $(window).width(), boundsY = $(window).height(), menuWidth = $menu.find('.dropdown-menu').outerWidth(), menuHeight = $menu.find(
                    '.dropdown-menu').outerHeight(), tp = {
                "position" : "absolute"
            }, Y, X;
